...
function lesson2_PolygonCreator() {
  ...
  function showGrids() {
    ...
    Coordinates.drawGrid(scene, {size: 100, scale: 1, orientation: "z"});
    Coordinates.drawAxes(scene, {axisLength: 4, axisOrientation: "x", axisRadius: 0.02});
    Coordinates.drawAxes(scene, {axisLength: 3, axisOrientation: "y", axisRadius: 0.02});
  }
