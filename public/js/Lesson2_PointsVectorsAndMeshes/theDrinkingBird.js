...
function createBody() {
  ...
  sphere.position.z = 0;	// centered at origin
  scene.add( sphere );
  ...
  cylinder.position.z = 0;	// centered at origin
  scene.add( cylinder );
}
...
function createHead() {
  ...
  var cylinderMaterial = new THREE.MeshLambertMaterial( { color: 0x0000D0 } );
  var cylinder = new THREE.Mesh(
    new THREE.CylinderGeometry( 52, 52, 10, 32 ), cylinderMaterial);
  cylinder.position.x = 0;
  cylinder.position.y = 604;
  cylinder.position.z = 0;	// centered at origin
  scene.add( cylinder );
