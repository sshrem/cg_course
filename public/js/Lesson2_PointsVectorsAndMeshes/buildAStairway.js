/**
 * Created by Shimon on 16/07/2017.
 */
////////////////////////////////////////////////////////////////////////////////
// Staircase exercise                                                         //
...
function createStairs() {
  ...
  for (var i=0; i<6 ;i++){
    ...
    stepMesh.position.y = verticalStepHeight*(i+0.5) + stepThickness*i;	// half of height: put it above ground plane
    stepMesh.position.z = horizontalStepDepth*i - stepThickness*i;			// centered at origin
    scene.add( stepMesh );
    ...
    stepMesh.position.y = stepThickness*(i+0.5) + verticalStepHeight*(i+1);
    // Push step forward by half the depth, minus half the vertical step's thickness
    stepMesh.position.z = horizontalStepDepth*(i+0.5) - stepHalfThickness*(2*i+1);
    scene.add( stepMesh );
  }
